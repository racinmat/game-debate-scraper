...
column_headers = ["ID", "Title", "EUrelease", "USrelease", "AUrelease", "Genre", "Theme",  # 6 täs rivillä
                  "INTELCPU1CLK", "INTELCPU1CORES", "INTELCPU1", "AMDCPU1CLK", "AMDCPU1CORE", "AMDCPU1", "NVIDIAGPU1",
                  "NVIDIAGPU1MEMORY", "AMDGPU1", "AMDGPU1MEMORY", "RAM1", "OS1", "DX1", "HDD1",
                  "INTELCPU2CLK", "INTELCPU2CORES", "INTELCPU2", "AMDCPU2CLK", "AMDCPU2CORE", "AMDCPU2", "NVIDIAGPU2",
                  "NVIDIAGPU2MEMORY", "AMDGPU2", "AMDGPU2MEMORY", "RAM2", "OS2", "DX2", "HDD2",
                  "INTELCPU3CLK", "INTELCPU3CORES", "INTELCPU3", "AMDCPU3CLK", "AMDCPU3CORE", "AMDCPU3", "NVIDIAGPU3",
                  "NVIDIAGPU3MEMORY", "AMDGPU3", "AMDGPU3MEMORY", "RAM3", "OS3", "DX3", "HDD3"]
